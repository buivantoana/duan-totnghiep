...
let searchOrder = async (req, res) => {
    try {
        let data = await orderService.searchOrder(req.query.value);
        return res.status(200).json(data);
    } catch (error) {
        console.log(error)
        return res.status(200).json({
...
let getTopUsersByTotalSpentWithRank = async (req, res) => {
    try {
        let data = await orderService.getTopUsersByTotalSpentWithRank();
        return res.status(200).json(data);
    } catch (error) {
        console.log(error)
        return res.status(200).json({
