...
import uploadController from '../controllers/uploadImage';
...
let initwebRoutes = (app) => {
    ...
    router.get('/api/get-all-products', middlewareControllers.verifyTokenAdmin, productController.getAllProducts)
    ...
    router.get('/api/get-product-top', productController.getTopSellingProducts)
    //==================API BANNER=============================//
    ...
    // ================API Upload Image========================
    router.post('/api/upload-image', upload.single('image'), uploadController.uploadImageController)
    router.delete('/api/delete-image', uploadController.deleteImageController)
    // ===============API Size===================
    router.get('/api/size', sizeController.getAllSizes);
    router.get('/api/size/:id', sizeController.getDetailSizes);  // Lấy danh sách size
    router.post('/api/size', sizeController.createSize);   // Thêm size mới
    router.put('/api/size/:id', sizeController.updateSize); // Cập nhật size
    router.delete('/api/size/:id', sizeController.deleteSize);
    // ===============API Color===================
    router.get('/api/color', colorController.getAllColors);
    router.get('/api/color/:id', colorController.getDetailColor);  // Lấy danh sách color
    router.post('/api/color', colorController.createColor);   // Thêm color mới
    router.put('/api/color/:id', colorController.updateColor); // Cập nhật color
    ...
    // ===============API Favorite===================
    router.get('/api/product-favorite/:userId', favoriteController.getAllFavoritesByUser);
    router.post('/api/product-favorite', favoriteController.createFavorite);
    router.delete('/api/product-favorite/:userId/:productId', favoriteController.deleteFavorite);
    // ===============API RANK===================
    router.get('/api/rank', orderController.getTopUsersByTotalSpentWithRank);
