...
import { getAllBanner, getProductFeatureService, getProductNewService, getNewBlog, getProductRecommendService, getRank } from '../../services/userService';
...
function HomePage(props) {
    ...
    console.log(dataNewProductFeature)
    return (
        <div>
            <Slider {...settings}>
