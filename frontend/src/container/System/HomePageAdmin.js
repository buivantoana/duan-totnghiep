...
import ManageSize from './Size/ManageSize';
                    ...
                    <div id="layoutSidenav">
                        ...
                        <div id="layoutSidenav_content">
                            <main>
                                ...
                                <Route exact path="/admin/list-size">
                                    <ManageSize />
                                </Route>
                                <Route exact path="/admin/add-size">
                                    <AddSize />
                                </Route>
                                <Route exact path="/admin/edit-size/:id">
                                    <AddSize />
                                </Route>
                                <Route exact path="/admin/list-color">
                                    <ManageColor />
                                </Route>
                                <Route exact path="/admin/add-color">
                                    <AddColor />
                                </Route>
                                <Route exact path="/admin/edit-color/:id">
                                    <AddColor />
                                </Route>
                                <Route exact path="/admin/list-product-variant">
                                    <ManageProductVariant />
                                </Route>
                                <Route exact path="/admin/add-product-variant">
                                    <AddProductVariant />
                                </Route>
                                <Route exact path="/admin/edit-product-variant/:id">
                                    <AddProductVariant />
                                </Route>
