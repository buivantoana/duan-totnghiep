                                ...
                                <>
                                    ...
                                    <div className="content-center">
                                        <span>
                                            ...
                                            {DataOrder.addressData.shipAdress}
                                        </span>
                                    </div>
                                </>
                            }
                                                    ...
                                                    return (
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div className="media">
                                                                    <div className="d-flex">
                                                                        <img style={{ width: '147px', height: '100px', objectFit: 'cover' }} src={item.image} alt="" />
                                                                    </div>
                                                                    {name}
                                                                </div>
                                                            </td>
                                                            <td> {item.size}</td>
                                                            <td><div style={{ width: "20px", height: "20px", borderRadius: "5px", background: item.color }}></div></td>
                                                            ...
                                                            <td style={{ textAlign: 'center' }}>
                                                                ...
                                                                <h5 style={{ color: '#ee4d2d' }}>{CommonUtils.formatter.format(item.quantity * item.realPrice)}</h5>
