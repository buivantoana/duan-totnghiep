                            ...
                            <tbody>
                                ...
                                {dataCart && dataCart.length > 0 &&
                                    dataCart.map((item, index) => {
                                        ...
                                        return (
                                            <ShopCartItem isOrder={false} id={item.id} productId={item.product.id} userId={user && user.id} color={item.productdetailcolor} productdetailsizeId={item.productdetailsizeId} key={index} name={name} price={item.product.discountPrice} quantity={item.quantity} image={item.product.image} />
                                        )
                                    })
                                }
                            </tbody>
