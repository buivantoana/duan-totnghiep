...
function MainShop(props) {
    ...
    useEffect(() => {
        ...
        setSizeId(props.SizeId)
        setColorId(props.colorId)
    ...
    }, [props.categoryId, props.brandId, props.SizeId, props.colorId])
        ...
        <div className="col-lg-9">
            <div className="product_top_bar">
                <div className="left_dorp">
                    ...
                    <div style={{ display: 'inline-block', marginLeft: '10px', width: '300px', height: "40px" }}>
                ...
                <div className="row">
                    {dataProduct && dataProduct.length > 0 &&
                        dataProduct.map((item, index) => {
                            return (
                                <ItemProduct id={item.id} width={"255px"} height={"254px"} type="col-lg-4 col-md-6" name={item.name} img={item.image}
